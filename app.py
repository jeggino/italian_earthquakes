...
def get_data():
    try:
        ...
        endtime = col_2.sidebar.date_input("End time", value=None, min_value=None, max_value=None, key=None, help=None, on_change=None, args=None, kwargs=None, disabled=False, label_visibility="visible")
