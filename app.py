...
def get_data():
    ...
    df_raw = df_raw.read_csv("https://webservices.ingv.it/fdsnws/event/1/query?starttime=2000-02-22T00%3A00%3A00&endtime=2023-02-23T23%3A59%3A59&minmag=2&maxmag=10&mindepth=-10&maxdepth=1000&minlat=-90&maxlat=90&minlon=-180&maxlon=180&minversion=100&orderby=time-asc&format=text&limit=10000",sep="|")[['Time', 'Latitude', 'Longitude', 'Depth/Km', 'Magnitude','EventLocationName']]
