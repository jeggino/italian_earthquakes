...
def get_data():
    ...
    return  df_raw 
date = st.date_input("date", value=None, min_value=None, max_value=None, key=None, help=None, on_change=None, args=None, kwargs=None, disabled=False, label_visibility="visible")
st.write(str(date))
